        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              className="w-5 h-5 fill-white/80 hover:fill-white transition"
            >
          ...
          <a
            ...
            bg-white text-black text-sm font-medium hover:scale-105 transition"
          >
            Contact
          </a>
        </div>
